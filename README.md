...
I am a software engineer specializing in **machine learning pipelines**, **distributed backend systems**, and **hardware-software integration**. My current research focuses on autonomous multi-agent architectures (Agentic AI), the Model Context Protocol (MCP), and optimizing ML inference on constrained edge devices.
